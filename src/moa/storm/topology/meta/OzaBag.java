...
public class OzaBag implements Serializable {
	...
	public void buildLearnPart(IStateFactory cassandra,
		...
		builder.setBolt(
				"deserialize",
				new TopologyBroadcastBolt("learn",
						LearnSpout.LEARN_STREAM_FIELDS), num_workers)
				.shuffleGrouping("learner_stream", LearnSpout.EVENT_STREAM);

		builder.setBolt(
				"learn_local_grouping",
				new WorkerBroadcastBolt("learn", LearnSpout.LEARN_STREAM_FIELDS),
				num_workers).customGrouping("deserialize", "learn",
				new AllGrouping());

		builder.setBolt("train_classifier",
				new TrainClassifierBolt(clasisifer_cli, cassandra),
	...
	public void buildEvaluatePart(IStateFactory cassandra,
		...
		builder.setBolt(
				"shared_storage",
				new SharedStorageBolt<Classifier>(cassandra,
		...
		builder.setBolt("evaluate_classifier",
				...
				.customGrouping("evaluate_local_grouping", "evaluate",
						new AllLocalGrouping()).setNumTasks(ensemble_size);
